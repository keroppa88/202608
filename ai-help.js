(function () {
  ...
  const JEV_HELP = "Geminiと同じ価格・テクニカル指標・類似局面・比較銘柄のデータを使い、短期（5営業日以内）・中期（20営業日以内）・長期（100営業日以内）の買い度を評価する。100%が買い、50%がイーブン、0%が売り。上昇確率ではなく売買評価の尺度。材料が足りない期間は判定保留にする。API利用料金が激安、1回あたり約0.1～0.2円。";
